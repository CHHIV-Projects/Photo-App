...
def ensure_icloud_backfill_schema(db_session: Session) -> IcloudBackfillSchemaSummary:
    ...
    inventory_defaults = {
        ...
        "backfill_completed": f"backfill_completed {boolean_false}",
        "backfill_completed_at": f"backfill_completed_at {timestamp_type}",
        "backfill_resolution_state": "backfill_resolution_state VARCHAR(64)",
        "acquisition_state": "acquisition_state VARCHAR(64)",
        ...
        "last_error_code": "last_error_code VARCHAR(128)",
        "last_error_message": "last_error_message VARCHAR(2048)",
        "acquisition_attempt_count": "acquisition_attempt_count INTEGER NOT NULL DEFAULT 0",
        "last_acquisition_attempt_at": f"last_acquisition_attempt_at {timestamp_type}",

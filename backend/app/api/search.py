...
def search_photos_endpoint(
    ...
    media_type_filter: str = Query(default="all"),
    include_live_photo_motion_companions: bool = Query(default=True),
    canonical_first: bool = Query(default=False),
    sort_by: str = Query(default="ingested_desc"),
    ...
    try:
        result = search_photos(
            ...
            include_live_photo_motion_companions=include_live_photo_motion_companions,
